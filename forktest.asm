...
00000020 <printf>:
{
  ...
  40:	e8 ab 03 00 00       	call   3f0 <write>
}
  ...
  54:	bb 88 04 00 00       	mov    $0x488,%ebx
{
  ...
  79:	e8 72 03 00 00       	call   3f0 <write>
  ...
  f6:	e8 f5 02 00 00       	call   3f0 <write>
}
 ...
 128:	e8 c3 02 00 00       	call   3f0 <write>
    exit(0);
 ...
 159:	e8 92 02 00 00       	call   3f0 <write>
      exit(0);
 ...
 189:	e8 62 02 00 00       	call   3f0 <write>
    exit(0);
 ...
 285:	31 f6                	xor    %esi,%esi
{
 ...
 2ac:	e8 37 01 00 00       	call   3e8 <read>
    if(cc < 1)
 ...
 2fc:	8b 45 08             	mov    0x8(%ebp),%eax
{
 ...
 308:	e8 03 01 00 00       	call   410 <open>
  if(fd < 0)
 ...
 31d:	e8 06 01 00 00       	call   428 <fstat>
  close(fd);
 322:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 325:	89 c6                	mov    %eax,%esi
  close(fd);
 327:	e8 cc 00 00 00       	call   3f8 <close>
  return r;
}
