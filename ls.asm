 ...
 111:	89 44 24 04          	mov    %eax,0x4(%esp)
{
 ...
 11e:	e8 cd 04 00 00       	call   5f0 <open>
 ...
 136:	e8 cd 04 00 00       	call   608 <fstat>
 ...
 15b:	e8 78 04 00 00       	call   5d8 <close>
}
 ...
 23c:	e8 97 03 00 00       	call   5d8 <close>
}
 ...
 296:	e8 2d 03 00 00       	call   5c8 <read>
 ...
 465:	31 f6                	xor    %esi,%esi
{
 ...
 48c:	e8 37 01 00 00       	call   5c8 <read>
    if(cc < 1)
 ...
 4dc:	8b 45 08             	mov    0x8(%ebp),%eax
{
 ...
 4e8:	e8 03 01 00 00       	call   5f0 <open>
  if(fd < 0)
 ...
 4fd:	e8 06 01 00 00       	call   608 <fstat>
  close(fd);
 502:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 505:	89 c6                	mov    %eax,%esi
  close(fd);
 507:	e8 cc 00 00 00       	call   5d8 <close>
  return r;
}
...
000005c0 <pipe>:
SYSCALL(pipe)
 5c0:	b8 04 00 00 00       	mov    $0x4,%eax
 5c5:	cd 40                	int    $0x40
 5c7:	c3                   	ret    
...
000005d8 <close>:
SYSCALL(close)
 5d8:	b8 15 00 00 00       	mov    $0x15,%eax
 5dd:	cd 40                	int    $0x40
 5df:	c3                   	ret    
...
000005e8 <exec>:
SYSCALL(exec)
 5e8:	b8 07 00 00 00       	mov    $0x7,%eax
 5ed:	cd 40                	int    $0x40
 5ef:	c3                   	ret    
...
00000600 <unlink>:
SYSCALL(unlink)
 600:	b8 12 00 00 00       	mov    $0x12,%eax
 605:	cd 40                	int    $0x40
 607:	c3                   	ret    

00000608 <fstat>:
SYSCALL(fstat)
 608:	b8 08 00 00 00       	mov    $0x8,%eax
 60d:	cd 40                	int    $0x40
 60f:	c3                   	ret    
...
00000620 <chdir>:
SYSCALL(chdir)
 620:	b8 09 00 00 00       	mov    $0x9,%eax
 625:	cd 40                	int    $0x40
 627:	c3                   	ret    

00000628 <dup>:
SYSCALL(dup)
 628:	b8 0a 00 00 00       	mov    $0xa,%eax
 62d:	cd 40                	int    $0x40
 62f:	c3                   	ret    

00000630 <getpid>:
SYSCALL(getpid)
 630:	b8 0b 00 00 00       	mov    $0xb,%eax
 635:	cd 40                	int    $0x40
 637:	c3                   	ret    

00000638 <sbrk>:
SYSCALL(sbrk)
 638:	b8 0c 00 00 00       	mov    $0xc,%eax
 63d:	cd 40                	int    $0x40
 63f:	c3                   	ret    

00000640 <sleep>:
SYSCALL(sleep)
 640:	b8 0d 00 00 00       	mov    $0xd,%eax
 645:	cd 40                	int    $0x40
 647:	c3                   	ret    

00000648 <uptime>:
SYSCALL(uptime)
 648:	b8 0e 00 00 00       	mov    $0xe,%eax
 64d:	cd 40                	int    $0x40
 64f:	c3                   	ret    
 ...
 67e:	84 db                	test   %bl,%bl
{
 ...
 6e7:	e8 e4 fe ff ff       	call   5d0 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 763:	e8 68 fe ff ff       	call   5d0 <write>
 ...
 7ce:	e8 fd fd ff ff       	call   5d0 <write>
 ...
 7e9:	e8 e2 fd ff ff       	call   5d0 <write>
  for(i = 0; fmt[i]; i++){
 ...
 867:	e8 64 fd ff ff       	call   5d0 <write>
        while(*s != 0){
 ...
 8ae:	e8 1d fd ff ff       	call   5d0 <write>
      state = 0;
 ...
 8de:	e8 ed fc ff ff       	call   5d0 <write>
      state = 0;
...
malloc(uint nbytes)
{
 ...
 9fe:	e8 35 fc ff ff       	call   638 <sbrk>
  if(p == (char*)-1)
