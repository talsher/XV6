   ...
   b:	31 db                	xor    %ebx,%ebx
{
  ...
  af:	e8 0c 03 00 00       	call   3c0 <open>
...
//    printf(fd, "%d\n", i);
  ...
  d0:	e8 cb 02 00 00       	call   3a0 <write>
  for(i = 0; i < 20; i++)
  d5:	4b                   	dec    %ebx
  ...
  close(fd);
  e0:	e8 c3 02 00 00       	call   3a8 <close>
  printf(1, "read\n");
 ...
 107:	e8 b4 02 00 00       	call   3c0 <open>
 ...
 120:	e8 73 02 00 00       	call   398 <read>
  for (i = 0; i < 20; i++)
 125:	4b                   	dec    %ebx
 126:	75 e8                	jne    110 <main+0x110>
  close(fd);
 128:	89 3c 24             	mov    %edi,(%esp)
 12b:	e8 78 02 00 00       	call   3a8 <close>
 ...
 235:	31 f6                	xor    %esi,%esi
{
 ...
 25c:	e8 37 01 00 00       	call   398 <read>
    if(cc < 1)
 ...
 2ac:	8b 45 08             	mov    0x8(%ebp),%eax
{
 ...
 2b8:	e8 03 01 00 00       	call   3c0 <open>
  if(fd < 0)
 ...
 2cd:	e8 06 01 00 00       	call   3d8 <fstat>
  close(fd);
 2d2:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2d5:	89 c6                	mov    %eax,%esi
  close(fd);
 2d7:	e8 cc 00 00 00       	call   3a8 <close>
  return r;
}
 ...
 44e:	84 db                	test   %bl,%bl
{
 ...
 4b7:	e8 e4 fe ff ff       	call   3a0 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 533:	e8 68 fe ff ff       	call   3a0 <write>
 ...
 59e:	e8 fd fd ff ff       	call   3a0 <write>
 ...
 5b9:	e8 e2 fd ff ff       	call   3a0 <write>
  for(i = 0; fmt[i]; i++){
 ...
 637:	e8 64 fd ff ff       	call   3a0 <write>
        while(*s != 0){
 ...
 67e:	e8 1d fd ff ff       	call   3a0 <write>
      state = 0;
 ...
 6ae:	e8 ed fc ff ff       	call   3a0 <write>
      state = 0;
...
malloc(uint nbytes)
{
 ...
 7ce:	e8 35 fc ff ff       	call   408 <sbrk>
  if(p == (char*)-1)
