  ...
  54:	bb 68 04 00 00       	mov    $0x468,%ebx
{
  ...
  7e:	eb 12                	jmp    92 <forktest+0x42>
    if(pid == 0)
  80:	0f 84 d0 00 00 00    	je     156 <forktest+0x106>
  for(n=0; n<N; n++){
  86:	43                   	inc    %ebx
  87:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
  8d:	8d 76 00             	lea    0x0(%esi),%esi
  90:	74 6e                	je     100 <forktest+0xb0>
    pid = fork();
  ...
  a0:	74 1a                	je     bc <forktest+0x6c>
  a2:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if(wait() < 0){
  b0:	e8 1b 03 00 00       	call   3d0 <wait>
  b5:	85 c0                	test   %eax,%eax
  b7:	78 78                	js     131 <forktest+0xe1>
  for(; n > 0; n--){
  b9:	4b                   	dec    %ebx
  ba:	75 f4                	jne    b0 <forktest+0x60>
  bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(wait() != -1){
  c0:	e8 0b 03 00 00       	call   3d0 <wait>
  c5:	40                   	inc    %eax
  c6:	0f 85 96 00 00 00    	jne    162 <forktest+0x112>
  write(fd, s, strlen(s));
  cc:	c7 04 24 9a 04 00 00 	movl   $0x49a,(%esp)
  d3:	e8 28 01 00 00       	call   200 <strlen>
  d8:	ba 9a 04 00 00       	mov    $0x49a,%edx
  dd:	89 54 24 04          	mov    %edx,0x4(%esp)
  e1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  e8:	89 44 24 08          	mov    %eax,0x8(%esp)
  ec:	e8 f7 02 00 00       	call   3e8 <write>
}
 ...
 12c:	e8 97 02 00 00       	call   3c8 <exit>
  write(fd, s, strlen(s));
 131:	c7 04 24 73 04 00 00 	movl   $0x473,(%esp)
 138:	e8 c3 00 00 00       	call   200 <strlen>
 13d:	b9 73 04 00 00       	mov    $0x473,%ecx
 ...
 15d:	e8 66 02 00 00       	call   3c8 <exit>
  write(fd, s, strlen(s));
 162:	c7 04 24 87 04 00 00 	movl   $0x487,(%esp)
 169:	e8 92 00 00 00       	call   200 <strlen>
 16e:	c7 44 24 04 87 04 00 	movl   $0x487,0x4(%esp)
 175:	00 
