 ...
 115:	31 f6                	xor    %esi,%esi
{
 ...
 13c:	e8 37 01 00 00       	call   278 <read>
    if(cc < 1)
 ...
 18c:	8b 45 08             	mov    0x8(%ebp),%eax
{
 ...
 198:	e8 03 01 00 00       	call   2a0 <open>
  if(fd < 0)
 ...
 1ad:	e8 06 01 00 00       	call   2b8 <fstat>
  close(fd);
 1b2:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1b5:	89 c6                	mov    %eax,%esi
  close(fd);
 1b7:	e8 cc 00 00 00       	call   288 <close>
  return r;
}
...
00000268 <wait_stat>:
SYSCALL(wait_stat)
 268:	b8 19 00 00 00       	mov    $0x19,%eax
 26d:	cd 40                	int    $0x40
 26f:	c3                   	ret    
...
00000310 <priority>:
 310:	b8 18 00 00 00       	mov    $0x18,%eax
 315:	cd 40                	int    $0x40
 317:	c3                   	ret    
 ...
 32e:	84 db                	test   %bl,%bl
{
 ...
 397:	e8 e4 fe ff ff       	call   280 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 413:	e8 68 fe ff ff       	call   280 <write>
 ...
 47e:	e8 fd fd ff ff       	call   280 <write>
 ...
 499:	e8 e2 fd ff ff       	call   280 <write>
  for(i = 0; fmt[i]; i++){
 ...
 517:	e8 64 fd ff ff       	call   280 <write>
        while(*s != 0){
 ...
 55e:	e8 1d fd ff ff       	call   280 <write>
      state = 0;
 ...
 58e:	e8 ed fc ff ff       	call   280 <write>
      state = 0;
...
malloc(uint nbytes)
{
 ...
 6ae:	e8 35 fc ff ff       	call   2e8 <sbrk>
  if(p == (char*)-1)
