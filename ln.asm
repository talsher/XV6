   ...
   a:	83 7d 08 03          	cmpl   $0x3,0x8(%ebp)
{
  ...
  40:	e8 cb 02 00 00       	call   310 <link>
 ...
 165:	31 f6                	xor    %esi,%esi
{
 ...
 18c:	e8 37 01 00 00       	call   2c8 <read>
    if(cc < 1)
 ...
 1dc:	8b 45 08             	mov    0x8(%ebp),%eax
{
 ...
 1e8:	e8 03 01 00 00       	call   2f0 <open>
  if(fd < 0)
 ...
 1fd:	e8 06 01 00 00       	call   308 <fstat>
  close(fd);
 202:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 205:	89 c6                	mov    %eax,%esi
  close(fd);
 207:	e8 cc 00 00 00       	call   2d8 <close>
  return r;
}
...
000002b8 <wait_stat>:
SYSCALL(wait_stat)
 2b8:	b8 19 00 00 00       	mov    $0x19,%eax
 2bd:	cd 40                	int    $0x40
 2bf:	c3                   	ret    
 ...
 37e:	84 db                	test   %bl,%bl
{
 ...
 3e7:	e8 e4 fe ff ff       	call   2d0 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 463:	e8 68 fe ff ff       	call   2d0 <write>
 ...
 4ce:	e8 fd fd ff ff       	call   2d0 <write>
 ...
 4e9:	e8 e2 fd ff ff       	call   2d0 <write>
  for(i = 0; fmt[i]; i++){
 ...
 567:	e8 64 fd ff ff       	call   2d0 <write>
        while(*s != 0){
 ...
 5ae:	e8 1d fd ff ff       	call   2d0 <write>
      state = 0;
 ...
 5de:	e8 ed fc ff ff       	call   2d0 <write>
      state = 0;
...
malloc(uint nbytes)
{
 ...
 6fe:	e8 35 fc ff ff       	call   338 <sbrk>
  if(p == (char*)-1)
