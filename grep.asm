   ...
   c:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
{
  ...
  3b:	e8 80 05 00 00       	call   5c0 <open>
  ...
  5f:	e8 44 05 00 00       	call   5a8 <close>
  for(i = 2; i < argc; i++){
 ...
 255:	31 f6                	xor    %esi,%esi
{
 ...
 27b:	e8 18 03 00 00       	call   598 <read>
 ...
 2f1:	e8 aa 02 00 00       	call   5a0 <write>
 ...
 435:	31 f6                	xor    %esi,%esi
{
 ...
 45c:	e8 37 01 00 00       	call   598 <read>
    if(cc < 1)
 ...
 4ac:	8b 45 08             	mov    0x8(%ebp),%eax
{
 ...
 4b8:	e8 03 01 00 00       	call   5c0 <open>
  if(fd < 0)
 ...
 4cd:	e8 06 01 00 00       	call   5d8 <fstat>
  close(fd);
 4d2:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4d5:	89 c6                	mov    %eax,%esi
  close(fd);
 4d7:	e8 cc 00 00 00       	call   5a8 <close>
  return r;
}
...
00000588 <wait_stat>:
SYSCALL(wait_stat)
 588:	b8 19 00 00 00       	mov    $0x19,%eax
 58d:	cd 40                	int    $0x40
 58f:	c3                   	ret    
 ...
 64e:	84 db                	test   %bl,%bl
{
 ...
 6b7:	e8 e4 fe ff ff       	call   5a0 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 733:	e8 68 fe ff ff       	call   5a0 <write>
 ...
 79e:	e8 fd fd ff ff       	call   5a0 <write>
 ...
 7b9:	e8 e2 fd ff ff       	call   5a0 <write>
  for(i = 0; fmt[i]; i++){
 ...
 837:	e8 64 fd ff ff       	call   5a0 <write>
        while(*s != 0){
 ...
 87e:	e8 1d fd ff ff       	call   5a0 <write>
      state = 0;
 ...
 8ae:	e8 ed fc ff ff       	call   5a0 <write>
      state = 0;
...
malloc(uint nbytes)
{
 ...
 9ce:	e8 35 fc ff ff       	call   608 <sbrk>
  if(p == (char*)-1)
