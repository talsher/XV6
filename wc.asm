...
main(int argc, char *argv[])
{
  ...
  2b:	e8 00 04 00 00       	call   430 <open>
  ...
  51:	e8 c2 03 00 00       	call   418 <close>
  for(i = 1; i < argc; i++){
  ...
  b6:	31 db                	xor    %ebx,%ebx
{
  ...
  e8:	e8 1b 03 00 00       	call   408 <read>
 ...
 2a5:	31 f6                	xor    %esi,%esi
{
 ...
 2cc:	e8 37 01 00 00       	call   408 <read>
    if(cc < 1)
 ...
 31c:	8b 45 08             	mov    0x8(%ebp),%eax
{
 ...
 328:	e8 03 01 00 00       	call   430 <open>
  if(fd < 0)
 ...
 33d:	e8 06 01 00 00       	call   448 <fstat>
  close(fd);
 342:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 345:	89 c6                	mov    %eax,%esi
  close(fd);
 347:	e8 cc 00 00 00       	call   418 <close>
  return r;
}
 ...
 4be:	84 db                	test   %bl,%bl
{
 ...
 527:	e8 e4 fe ff ff       	call   410 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a3:	e8 68 fe ff ff       	call   410 <write>
 ...
 60e:	e8 fd fd ff ff       	call   410 <write>
 ...
 629:	e8 e2 fd ff ff       	call   410 <write>
  for(i = 0; fmt[i]; i++){
 ...
 6a7:	e8 64 fd ff ff       	call   410 <write>
        while(*s != 0){
 ...
 6ee:	e8 1d fd ff ff       	call   410 <write>
      state = 0;
 ...
 71e:	e8 ed fc ff ff       	call   410 <write>
      state = 0;
...
malloc(uint nbytes)
{
 ...
 83e:	e8 35 fc ff ff       	call   478 <sbrk>
  if(p == (char*)-1)
