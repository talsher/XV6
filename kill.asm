...
main(int argc, char **argv)
{
  ...
  30:	e8 9b 02 00 00       	call   2d0 <kill>
  for(i=1; i<argc; i++)
 ...
 155:	31 f6                	xor    %esi,%esi
{
 ...
 17c:	e8 37 01 00 00       	call   2b8 <read>
    if(cc < 1)
 ...
 1cc:	8b 45 08             	mov    0x8(%ebp),%eax
{
 ...
 1d8:	e8 03 01 00 00       	call   2e0 <open>
  if(fd < 0)
 ...
 1ed:	e8 06 01 00 00       	call   2f8 <fstat>
  close(fd);
 1f2:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1f5:	89 c6                	mov    %eax,%esi
  close(fd);
 1f7:	e8 cc 00 00 00       	call   2c8 <close>
  return r;
}
 ...
 36e:	84 db                	test   %bl,%bl
{
 ...
 3d7:	e8 e4 fe ff ff       	call   2c0 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 453:	e8 68 fe ff ff       	call   2c0 <write>
 ...
 4be:	e8 fd fd ff ff       	call   2c0 <write>
 ...
 4d9:	e8 e2 fd ff ff       	call   2c0 <write>
  for(i = 0; fmt[i]; i++){
 ...
 557:	e8 64 fd ff ff       	call   2c0 <write>
        while(*s != 0){
 ...
 59e:	e8 1d fd ff ff       	call   2c0 <write>
      state = 0;
 ...
 5ce:	e8 ed fc ff ff       	call   2c0 <write>
      state = 0;
...
malloc(uint nbytes)
{
 ...
 6ee:	e8 35 fc ff ff       	call   328 <sbrk>
  if(p == (char*)-1)
