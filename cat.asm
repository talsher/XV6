...
main(int argc, char *argv[])
{
  ...
  2b:	e8 80 03 00 00       	call   3b0 <open>
  ...
  45:	e8 4e 03 00 00       	call   398 <close>
  for(i = 1; i < argc; i++){
...
000000a0 <cat>:
{
  ...
  c4:	e8 c7 02 00 00       	call   390 <write>
  ...
  e2:	e8 a1 02 00 00       	call   388 <read>
 ...
 225:	31 f6                	xor    %esi,%esi
{
 ...
 24c:	e8 37 01 00 00       	call   388 <read>
    if(cc < 1)
 ...
 29c:	8b 45 08             	mov    0x8(%ebp),%eax
{
 ...
 2a8:	e8 03 01 00 00       	call   3b0 <open>
  if(fd < 0)
 ...
 2bd:	e8 06 01 00 00       	call   3c8 <fstat>
  close(fd);
 2c2:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2c5:	89 c6                	mov    %eax,%esi
  close(fd);
 2c7:	e8 cc 00 00 00       	call   398 <close>
  return r;
}
 ...
 43e:	84 db                	test   %bl,%bl
{
 ...
 4a7:	e8 e4 fe ff ff       	call   390 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 523:	e8 68 fe ff ff       	call   390 <write>
 ...
 58e:	e8 fd fd ff ff       	call   390 <write>
 ...
 5a9:	e8 e2 fd ff ff       	call   390 <write>
  for(i = 0; fmt[i]; i++){
 ...
 627:	e8 64 fd ff ff       	call   390 <write>
        while(*s != 0){
 ...
 66e:	e8 1d fd ff ff       	call   390 <write>
      state = 0;
 ...
 69e:	e8 ed fc ff ff       	call   390 <write>
      state = 0;
...
malloc(uint nbytes)
{
 ...
 7be:	e8 35 fc ff ff       	call   3f8 <sbrk>
  if(p == (char*)-1)
